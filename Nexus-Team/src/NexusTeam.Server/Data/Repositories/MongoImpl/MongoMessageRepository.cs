    ...
    public class MongoMessageRepository : IMessageRepository
    {
        ...
        private static SharedMessage? MapToShared(DataMessage? dataMessage)
        {
            ...
            return new SharedMessage
            {
                ...
                ReplyToSenderId = dataMessage.ReplyToSenderId,
                ReplyToSenderName = dataMessage.ReplyToSenderName,
                ReplyToContent = dataMessage.ReplyToContent,
                IsForwarded = dataMessage.IsForwarded,
                ForwardedFromSenderId = dataMessage.ForwardedFromSenderId,
                ForwardedFromSenderName = dataMessage.ForwardedFromSenderName,
                Status = status,
                IsDeleted = dataMessage.IsDeleted,
                IsSystem = dataMessage.IsSystem,
        ...
        private static DataMessage MapToData(SharedMessage sharedMessage)
        {
            ...
            return new DataMessage
            {
                ...
                ReplyToSenderId = sharedMessage.ReplyToSenderId,
                ReplyToSenderName = sharedMessage.ReplyToSenderName,
                ReplyToContent = sharedMessage.ReplyToContent,
                IsForwarded = sharedMessage.IsForwarded,
                ForwardedFromSenderId = sharedMessage.ForwardedFromSenderId,
                ForwardedFromSenderName = sharedMessage.ForwardedFromSenderName,
                IsDeleted = sharedMessage.IsDeleted,
                IsSystem = sharedMessage.IsSystem,
